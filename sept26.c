...
int main(void) {
    ...
    scanf("%c", &firstletter);
    printf("Nice to meet you, %c", firstletter);

    //Question 3
    /* Now, do Part B questions 1 and 2 with functions. Return the specified value and
     * print it inside main. */
    int result1;
    result1 = getnumber();
    printf("Your number is %d", result1);
...
int getnumber(void){
    ...
    //scan it into the variable you made
    scanf("%d", &userinput);
    //return the value, you will print it in main
    return userinput;
}
